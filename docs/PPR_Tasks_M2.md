...
### [x] Task B2.1: 报表元数据接口 (Report Meta API)
* **执行步骤**: 
...
### [x] Task B2.2: Sa-Token 鉴权集成与透传拦截器
* **执行步骤**:
...
### [x] Task F2.3: 报表展示引擎 (Client Renderer) - 动态表单与表格
* **执行步骤**:
...
### [x] Task F2.4: 报表展示引擎 (Client Renderer) - ECharts 渲染与打包
* **执行步骤**:
